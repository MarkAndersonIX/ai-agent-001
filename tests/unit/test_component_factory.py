...
class TestComponentFactory:
    ...
    def test_register_vector_store(self):
        ...
        class TestVectorStore(VectorStore):
            ...
            def add_documents(self, documents): return []
            def similarity_search(self, query, k=5, filters=None): return []
            def delete_documents(self, doc_ids): return True
            def get_document(self, doc_id): return None
            def list_documents(self, filters=None, limit=None, offset=None): return []
            def count_documents(self, filters=None): return 0
    ...
    def test_register_memory_backend(self):
        ...
        class TestMemoryBackend(MemoryBackend):
            def __init__(self, config): pass
            def save_session(self, session_id, messages, agent_type, user_id=None, metadata=None): return True
            def load_session(self, session_id): return []
            def get_session_info(self, session_id): return None
            def delete_session(self, session_id): return True
            def list_sessions(self, user_id=None, agent_type=None, limit=None, offset=None): return []
            def append_message(self, session_id, message, agent_type): return True
            def get_recent_messages(self, session_id, limit=10): return []
            def count_sessions(self, user_id=None, agent_type=None): return 0
            def cleanup_expired_sessions(self, max_age_hours=24): return 0
        ...
        assert ComponentFactory._memory_backend_registry['test_memory'] == TestMemoryBackend
