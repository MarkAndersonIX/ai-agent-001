...
class TestInMemoryBackend:
    ...
    def test_get_session_info(self, memory_backend, sample_messages):
        ...
        memory_backend.save_session(session_id, sample_messages, "test_agent", "user123")
    ...
    def test_append_message(self, memory_backend, sample_messages):
        ...
        # Append new message
        new_message = ChatMessage(role="user", content="New message", timestamp=datetime.now())
    ...
    def test_append_message_new_session(self, memory_backend):
        ...
        message = ChatMessage(role="user", content="First message", timestamp=datetime.now())
    ...
    def test_get_recent_messages(self, memory_backend, sample_messages):
        ...
        many_messages = sample_messages + [
            ChatMessage(role="assistant", content="Message 4", timestamp=datetime.now()),
    ...
    def test_list_sessions(self, memory_backend, sample_messages):
        ...
        for session_id, agent_type, user_id in sessions_data:
            memory_backend.save_session(session_id, sample_messages, agent_type, user_id)
