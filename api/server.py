...
from core.base_config_provider import ConfigProvider, CompositeConfigProvider, EnvironmentConfigProvider
from providers.yaml_config_provider import YAMLConfigProvider, create_default_config_file
...
class AgentAPI:
    ...
    def _register_routes(self) -> None:
        ...
        def get_session(agent_type, session_id):
            ...
            try:
                if agent_type not in self.agents:
                    return jsonify({'error': f'Agent type "{agent_type}" not found'}), 404
        ...
        @self.app.route('/agents/<agent_type>/sessions/<session_id>', methods=['DELETE'])
        ...
        def get_config():
            ...
            try:
                ...
                config_info = {
                    ...
                    'memory': {
                        'type': self.config.get_config('memory.type')
                    },
                    'llm': {
...
def create_app(config_path: Optional[str] = None) -> AgentAPI:
    ...
    providers = [
        ...
        YAMLConfigProvider(config_paths)
    ]
