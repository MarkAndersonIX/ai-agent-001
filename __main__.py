...
Examples:
  ...
  python -m ai_agent_base cli interactive code_assistant
    ...
    cli_parser.add_argument('--api-url', default='http://localhost:8000', help='API server URL')
    ...
    chat_parser.add_argument('agent', choices=['general', 'code_assistant', 'research_agent', 'document_qa'])
    ...
    # Interactive command
    interactive_parser = cli_subparsers.add_parser('interactive', help='Start interactive session')
    interactive_parser.add_argument('agent', choices=['general', 'code_assistant', 'research_agent', 'document_qa'])
    ...
    tools_parser.add_argument('agent', choices=['general', 'code_assistant', 'research_agent', 'document_qa'])
    
    # History command
    history_parser = cli_subparsers.add_parser('history', help='Show session history')
    history_parser.add_argument('agent', choices=['general', 'code_assistant', 'research_agent', 'document_qa'])
